...
class JSONValueFromStreamTests: TestCase {
    ...
    func testInvalidEscapedString() throws {
    ...
    func testEscapedUnicodeString() throws {
    ...
    func testArray() throws {
        ...
        let strings = try JSON.Value(from: InputByteStream(#"["one", "two"]"#))
